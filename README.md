...
# 优势
   ...
   * 没有中心化的网关或者localBitcoins场外交易这样的中心化撮合网站，能像比特币系统一样不停机工作。
...
新用户需要一点ETH。可以和提供P2P CNY充值服务的用户交易。为了安全，交易过程分多次进行。建议每次不超过50块。智能合约为新用户提供不超过50块的担保。如果交易顺利完成，新用户就可以和其它任何人安全地点对点地交易了。
